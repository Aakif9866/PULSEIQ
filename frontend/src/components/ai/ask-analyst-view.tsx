...
/** @deprecated The legacy, unvalidated single-query AI Analyst path —
 * see docs/AI_ANALYTICS.md's "Deprecated: /ask" note. Reachable only via
 * VITE_AI_ANALYST_ENGINE=ask (lib/feature-flags.ts); AnalyzeAnalystView
 * is the default. */
